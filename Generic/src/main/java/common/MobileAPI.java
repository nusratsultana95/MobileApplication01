...
public class MobileAPI {
    ...
    public static AppiumDriver getDriver(String OS, String deviceName, String version,
        ...
        cap.setCapability(MobileCapabilityType.DEVICE_NAME, deviceName);//deviceName is value & before that are key
        //this capability is static for for both ios/android
        if (OS.equalsIgnoreCase("android")) {
            //those capabilities are depend on your platform(ios/android)
            cap.setCapability(MobileCapabilityType.PLATFORM_NAME, MobilePlatform.ANDROID);
            cap.setCapability(MobileCapabilityType.PLATFORM_VERSION, version);
            cap.setCapability(MobileCapabilityType.APP_PACKAGE, "com.tdbank");//this data we'll get from developer
            cap.setCapability(MobileCapabilityType.APP_ACTIVITY, "com.td.dcts.android.us.app.SplashScreenActivity");//this data we'll get from developer
